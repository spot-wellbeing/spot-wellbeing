...
const Home = () => (
  <>
    ...
    <main>
      ...
      >
        <p>
          <span className="text-bold">S</span>upport people’s physical and mental
          wellbeing through a holistic service designed and delivered by
          professionals.
        </p>
        <p>
          <span className="text-bold">P</span>revent ill health: poor mental and
          physical wellbeing, falls, isolation and loneliness, through education,
          intervention and bringing communities together.
        </p>
        <p>
          <span className="text-bold">O</span>ne service: a service which works with
          the whole person, their mental and physical health, social and
          environmental factors.
        </p>
        <p>
          <span className="text-bold">T</span>each each other: people are experts,
          professionals are experts. We can work together towards a healthier,
          safer Suffolk.
        </p>
      </ContentRow>
    </main>
